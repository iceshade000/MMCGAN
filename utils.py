...
from Add_Code import MMMC,MMMC_hdf5,MMMC_Folder
...
def prepare_parser():
  ...
  parser.add_argument(
    ...
    help='Name of the model module (default: %(default)s),BigGAN or MMMGAN')
  parser.add_argument(
  ...
  parser.add_argument(
    '--thrd', type=float, default=0.0,
    help='Threshold for determining if the anchoring is already successful: %(default)s)')
  parser.add_argument(
    '--anchor', type=int, default=5,
    help='Number of iteration for anchoring . (default: %(default)s)')
  ...
  parser.add_argument(
    '--num_save_copies', type=int, default=0,
    help='How many copies to save (default: %(default)s)')
  parser.add_argument(
    '--num_best_copies', type=int, default=0,
...
dset_dict = {'I32': dset.ImageFolder, 'I64': dset.ImageFolder, 
             ...
             'C10': dset.CIFAR10, 'C100': dset.CIFAR100,'CelebA':torchvision.datasets.ImageFolder}
imsize_dict = {'I32': 32, 'I32_hdf5': 32,
               'I64': 64, 'I64_hdf5': 64,
               'I128': 128, 'I128_hdf5': 128,
               'I256': 256, 'I256_hdf5': 256,
               'C10': 32, 'C100': 32,'CelebA':64}
root_dict = {'I32': 'ImageNet', 'I32_hdf5': 'ILSVRC32.hdf5',
             'I64': 'ImageNet', 'I64_hdf5': 'ILSVRC64.hdf5',
             'I128': 'ImageNet', 'I128_hdf5': 'ILSVRC128.hdf5',
             'I256': 'ImageNet', 'I256_hdf5': 'ILSVRC256.hdf5',
             'C10': 'cifar', 'C100': 'cifar','CelebA':'celeba'}
nclass_dict = {'I32': 1000, 'I32_hdf5': 1000,
               'I64': 1000, 'I64_hdf5': 1000,
               'I128': 1000, 'I128_hdf5': 20,
               'I256': 1000, 'I256_hdf5': 1000,
               'C10': 10, 'C100': 100,'CelebA':1}
...
def get_data_loaders(dataset, data_root=None, augment=False, batch_size=64, 
                     ...
                     num_epochs=500, use_multiepoch_sampler=False,model='BigGAN',
                     **kwargs):
  ...
  if model.find('MMM') != -1:
    print('use MMM!')
    import os
    if os.path.exists('Code/'+dataset+'.npy'):
      code=np.load('Code/'+dataset+'.npy')
      if 'hdf5' in dataset:
        train_set = MMMC_hdf5(train_set, name=dataset, code=code)
      elif 'C10' in dataset:
        train_set=MMMC(train_set,name=dataset,code=code)
      else:
        train_set=MMMC_Folder(train_set,name=dataset,code=code)
    else:
      from model_for_code import Decoder,Encoder
      Enc=Encoder(**kwargs).cuda()
      Dec=Decoder(**kwargs).cuda()
      Enc,Dec=torch.nn.DataParallel(Enc),torch.nn.DataParallel(Dec)
      if 'hdf5' in dataset:
        train_set = MMMC_hdf5(train_set,name=dataset, Encoder=Enc, Decoder=Dec)
      elif 'C10' in dataset:
        train_set = MMMC(train_set,name=dataset, Encoder=Enc, Decoder=Dec)
      else:
        train_set = MMMC_Folder(train_set, name=dataset, Encoder=Enc, Decoder=Dec)
...
def ortho(model, strength=1e-4, blacklist=[]):
  with torch.no_grad():
    for param in model.parameters():
      ...
      param.grad.data =param.grad.data+ strength * grad.view(param.shape)
...
def save_weights(G,G2, D, state_dict, weights_root, experiment_name,
  ...
  torch.save(G2.optim.state_dict(),
...
def load_weights(G,G2, D, state_dict, weights_root, experiment_name,
...
def name_from_config(config):
  ...
  'thrd%d' % config['thrd'],
  'anchor%d' % config['anchor'],
  'G_noSN' if config['G_param'] !='SN' else None,
